        ...
        return (
          ...
          >
            <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-1xl ">
              ...
              Your Dream Wedding Captured Perfectly - Wedding Photography in India -
              </span>{" "}
              When it comes to capturing the magic of your wedding day, trust a professional wedding
              photographer with years of experience in the India. We specialize in creating beautiful,
              timeless images that tell the story of your love. Whether you&apos;re in India
      ...
      {[...new Array(1).fill(1)].map((_, index) => {
        return (
          ...
          >
            <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-1xl ">
              <span className="font-bold text-neutral-700 dark:text-neutral-200">
              Capturing Your Baby’s Precious Moments - Baby Photoshoots in India
              </span>{" "} <br /> <br />
              There’s nothing more precious than your baby’s early milestones. Our professional baby
              photoshoots in India are designed to capture these fleeting
        ...
        return (
          ...
          >
            <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-1xl ">
             ...
             <span className="fw-semibold">Experienced Wedding Photographers</span> With extensive experience in the India wedding
             ...
             photography, we tailor our approach to suit your vision.
              <br /><br />
             <span className="fw-semibold">Serving India</span> We offer wedding photography services across
              the India, ensuring we are accessible no matter where
              you are.
              <br />
              <br />
        ...
        return (
          ...
          >
            <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-1xl ">
              ...
              Serving India, and the entire UAE, we provide expert photography
        ...
        return (
          ...
          >
            <p className="text-neutral-600 dark:text-neutral-400 text-base md:text-1xl ">
              ...
              <span className="fw-semibold">Baby Photography in India,</span>We offer convenient baby
              photoshoots across the India.<br /><br />
